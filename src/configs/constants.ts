...
export const INVOICE_EDIT_PATH        = '/invoice/v3/';
export const INVOICE_EDIT_STATUS_PATH = '/invoice/v3/status/';
...
export const PAYMENT_CREATE_PATH      = '/payment/v3';
export const PAYMENT_GET_PATH         = '/payments/';
export const PAYMENT_GET_ONE_PATH     = '/payment/';
export const PAYMENT_EDIT_PATH        = '/payment/v3/';
export const PAYMENT_EDIT_STATUS_PATH = '/payment/v3/status/';
